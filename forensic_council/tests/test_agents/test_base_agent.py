...
class TestAgent1Image:
    ...
    def test_task_count(self):
        """Test agent has correct task count (8)."""
        assert len(Agent1Image.task_decomposition.fget(None)) == 8
...
class TestAgent2Audio:
    ...
    def test_task_count(self):
        ...
        assert len(Agent2Audio.task_decomposition.fget(None)) == 10
...
class TestAgent3Object:
    ...
    def test_task_count(self):
        """Test agent has correct task count (9)."""
        assert len(Agent3Object.task_decomposition.fget(None)) == 9
...
class TestAgent4Video:
    ...
    def test_task_count(self):
        """Test agent has correct task count (9)."""
        assert len(Agent4Video.task_decomposition.fget(None)) == 9
...
class TestAgent5Metadata:
    ...
    def test_task_count(self):
        ...
        assert len(Agent5Metadata.task_decomposition.fget(None)) == 11
...
class TestAllAgentsTaskCounts:
    ...
    def test_all_five_agents_have_correct_task_counts(self):
        """Verify all 5 agents have correct task counts (8, 10, 9, 9, 11)."""
        expected_counts = {
            "Agent1Image": 8,
            "Agent2Audio": 10,
            "Agent3Object": 9,
